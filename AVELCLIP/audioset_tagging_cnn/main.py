...
class My_DataSet(torchvision.datasets.VisionDataset):
    ...
    def __getitem__(self, mask):
        ...
        audio_data = audio_feature[num_line].astype(float)
...
parser.add_argument('--checkpoint_path', type=str,
                    default="/home/hexiang/AVELCLIP/audioset_tagging_cnn/checkpoints/Cnn14_mAP=0.431.pth")
