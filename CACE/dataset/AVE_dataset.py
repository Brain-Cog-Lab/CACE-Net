...
class AVEDataset(Dataset):
    def __init__(self, data_root, split='train'):
        ...
        # self.visual_feature_path = "/home/hexiang/Encoders/data/visual_pytorch_opencv_resnet50_feature.h5"  #  visual_pytorch_opencv_resnet50_feature.h5
        # self.audio_feature_path = "/home/hexiang/Encoders/data/audio_pytorch_librosa_cnn14_feature.h5"
    ...
    def __getitem__(self, index):
        ...
        # visual_feat = torch.from_numpy(self.visual_feature[sample_index]).double()
